...
public class King extends Piece{
	...
	//Function to check if king can roque
	public boolean canRoque(Cell state[][], Rook r) {
		return !this.isMoved && !r.isMoved && !this.isindanger(state) && state[7][5].getpiece() == null && state[7][6].getpiece() == null;
	}
